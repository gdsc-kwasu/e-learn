...
},
{
  ...
  component: ComponentCreator('/blog/hello-world','722'),
  exact: true,
},
{
  path: '/blog/hola',
  component: ComponentCreator('/blog/hola','9fa'),
  exact: true,
},
{
  path: '/blog/tags',
  component: ComponentCreator('/blog/tags','822'),
  exact: true,
},
{
  path: '/blog/tags/docusaurus',
  component: ComponentCreator('/blog/tags/docusaurus','abe'),
  exact: true,
},
{
  path: '/blog/tags/facebook',
  component: ComponentCreator('/blog/tags/facebook','546'),
  exact: true,
},
{
  path: '/blog/tags/hello',
  component: ComponentCreator('/blog/tags/hello','d95'),
  exact: true,
},
{
  path: '/blog/tags/hola',
  component: ComponentCreator('/blog/tags/hola','f6a'),
  exact: true,
},
{
  path: '/blog/welcome',
  component: ComponentCreator('/blog/welcome','94b'),
  exact: true,
},
{
  path: '/docs',
...
{
  path: '/docs/ui/articles/articles',
  component: ComponentCreator('/docs/ui/articles/articles','32c'),
  exact: true,
},
{
  path: '/docs/ui/articles/figma',
  component: ComponentCreator('/docs/ui/articles/figma','71c'),
  exact: true,
},
{
...
{
  path: '/docs/ui/videos/figma-intro',
  component: ComponentCreator('/docs/ui/videos/figma-intro','200'),
  exact: true,
},
{
  path: '/docs/ui/videos/videos',
  component: ComponentCreator('/docs/ui/videos/videos','473'),
  exact: true,
},
]
},
